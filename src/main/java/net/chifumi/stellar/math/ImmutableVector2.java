...
public class ImmutableVector2<Type extends Number> implements Vector2<Type> {
    private final Type x;
    private final Type y;

    public ImmutableVector2(final Type x, final Type y) {
        this.x = x;
        this.y = y;
    }

    public ImmutableVector2(final Vector2<? extends Type> vector2) {
        x = vector2.getX();
        y = vector2.getY();
    }
